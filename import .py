...
def screenshot():
    ...
    img_path = os.path.expanduser("~\\Pictures\\ss.pngh")
    img.save(img_path)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "time" in query:
            ...
            speak("I'm sam created by Mr. Taheer and I'm a desktop voice assistant.")
            print("I'm sam created by Mr. Taheer and I'm a desktop voice assistant.")
